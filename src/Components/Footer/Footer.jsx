...
const Footer = () => {
    return (
        <div>
            <footer className="bg-[#1A1919] dark:bg-gray-900  lg:h-96 mt-10 ">
    <div className=" w-full p-4 lg:px-64 py-6 lg:py-8 ">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <h1 className='text-white text-2xl'>BD JOB BANK</h1>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">BD JOB BANK</a>. All Rights Reserved.
          </span>
